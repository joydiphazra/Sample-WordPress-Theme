<?php
/**
 * Template Name: LUNGVIEW DATA INSIGHT Page Template
*/
...
<?php wp_reset_query(); ?>
    	...
    	<div class="container">
            ...
            <a href="http://www.magview.com/solutions/lungview/compliance/" class="btn2">CONTINUE to COMPLIANCE</a>
        </div>
    </div>  	
