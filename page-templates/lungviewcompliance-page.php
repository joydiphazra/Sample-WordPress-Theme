...
$description = get_post_meta( get_the_ID(), 'description', true);
$benefits = get_post_meta( get_the_ID(), 'benefits', true);
$image = get_post_meta( get_the_ID(), 'benefits_image', true);
...
while (have_posts ()): the_post(); 
$description = get_post_meta( get_the_ID(), 'description', true);
$automated_breast_density_image = get_post_meta( get_the_ID(), 'image', true);
...
<div class="patient_bottom">
    	<div class="container">
            ...
            <a href="http://www.magview.com/solutions/patient-navigation/" class="btn2">CONTINUE TO PATIENT NAVIGATION</a>
        </div>
</div> 
