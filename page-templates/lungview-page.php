<?php
/**
 * Template Name: LUNG VIEW Page Template
*/

get_header(); ?>
<div class="video_bg">
	<div id="divId" class="div-hide">
    	<img src="<?php echo get_template_directory_uri(); ?>/images/lungview_banner.jpg">
    </div>
    <div class="video_con">
        <video width="100%" autoplay poster="<?php echo get_template_directory_uri(); ?>/images/check_hover.png" id="myVideo">
          <source src="<?php echo get_template_directory_uri(); ?>/videos/LungViewLogoAnim(wtagline).mp4" type="video/mp4">
		  <source src="<?php echo get_template_directory_uri(); ?>/videos/LungView-Logo-Anim_w-tagline__WEBM.webm" type="video/webm">
		  <source src="<?php echo get_template_directory_uri(); ?>/videos/LungView-Logo-Anim_w-tagline__OGV.ogv" type="video/ogg">
        </video>
    </div>
	</div> 
