...
<?php endif; wp_reset_query(); ?>
	...
	<div class="container"><a name="Patient Questionnaire"></a>
...
?> 
    	<h1 id="id1"><?php the_title(); ?></h1>
        <p><span style="font-size:22px;"><?php the_title(); ?></span><br>
		<?php echo $details_text; ?></p>
		<?php echo  $benefits; ?>
    </div>
    <div class="container"><h2>History Portal</h2></div>
    <div class="breastpatient_sec1">
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-6">
                	<h2 class="heading3"><?php echo $history_portal_text; ?></h2>
                    <a href="#" data-toggle="modal" data-target="#contact_form" class="btn2 white"><?php echo $more_button_text; ?></a> <!--<a href="<?php echo $account_manager_button_link; ?>" class="btn2 yellow"><?php echo $account_manager_button_text; ?></a>-->
                </div>
            </div>
        </div>
    </div>
    <div class="patient_sec2">
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-5">
                	<h3>Features:</h3>
...
$scheduling_interface_title = get_post_meta( get_the_ID(), 'scheduling_interface_title', true);
$scheduling_interface_description = get_post_meta( get_the_ID(), 'scheduling_interface_description', true);
$first_image = wp_get_attachment_url( $texting_module_image );
$second_image = wp_get_attachment_url( $follow_up_image );
?>	
    <div class="container"><h2><?php echo $scheduling_interface_title; ?></h2></div>
    <div class="patient_sec1" style="background:url(<?php echo get_template_directory_uri(); ?>/images/bg8.jpg) no-repeat center top;background-size:cover;">
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-6">
                	<h2 class="heading3"><?php echo $scheduling_interface_description; ?></h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-sm-5 col-sm-pull-5 center_767"><img src="<?php echo $airport_image; ?>" alt="" ></div>
            </div>
        </div>
    </div>
<?php endwhile; ?>	
...
?> 
    ...
    <div class="container"><a name="Risk Models"></a>
    	<h2 id="id3"><?php the_title(); ?></h2>
    ...
    <div class="patient_sec2">
    	<div class="container">
        	<h2><?php echo $risk_portal_title; ?></h2>
...
<?php wp_reset_query(); ?>	
    ...
    <div class="case_studies" style="background-color:#f5efd8;">
    	<div class="container">
        	        <div class="stories_holder">
        	<h2 class="heading newsuccess"><span>Success stories</span></h2>
...
?>
    <div class="patient_sec3"><a name="Patient Notification Portal"></a>
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-5">
                	<h3 id="id4"><?php the_title(); ?></h3>
                    <?php echo $description; ?>
                </div>
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $notificationbig_image; ?>" alt="" ></div>
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-sm-5 col-sm-pull-5 center_767"><img src="<?php echo $referring_image; ?>" alt="" ></div>
            </div>
        </div>
    </div>
    <div class="container">
...
?>
    <div class="patient_sec2"><a name="<?php the_title(); ?>"></a>
    	<div class="container">
        	<h2 id="id5"><?php the_title(); ?></h2>
...
?>	
    ...
    <div class="patient_sec3" style="background-color:#ececec;"><a name="Texting Module"></a>
    	<div class="container">
        	<div class="row" id="id6">
                ...
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $first_image; ?>" alt=""></div>
            </div>
        </div>
    </div>
    <div class="patient_sec3">
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-5 col-sm-push-7">
                ...
                <div class="col-sm-5 col-sm-pull-5 center_767"><img src="<?php echo $second_image; ?>" alt=""></div>
            </div>
        </div>
    </div>
<?php endwhile; ?>	
...
$airport_image = wp_get_attachment_url( $airport_monitor_image );
?> 	
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;"><a name="TechPad"></a>
    	<div class="container">
        	<div class="row" id="id2">
                ...
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $techpadbig_image; ?>" alt="" ></div>
            </div>
        </div>
    </div>
    <div class="container">
