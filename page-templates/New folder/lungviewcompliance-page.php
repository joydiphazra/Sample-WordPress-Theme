<?php
/**
 * Template Name: LUNGVIEW Compliance Page Template
*/
...
?>	
    ...
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;"><a name="<?php the_title(); ?>"></a>
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-5">
                	<h2><?php the_title(); ?></h2>
                ...
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $image1; ?>" alt="" ></div>
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-sm-5 col-sm-pull-5 center_767"><img src="<?php echo $automated_breast_density_image1; ?>" alt=""></div>
            </div>
        </div>
    </div>
<?php endwhile; ?>	
...
<?php wp_reset_query(); ?>
    	...
    	<div class="container">
            ...
            <a href="http://dev4work.com/magview/wp/solutions/patient-navigation/" class="btn2">CONTINUE TO PATIENT NAVIGATION</a>
        </div>
    </div>  
