...
<?php endif; wp_reset_query(); ?>
	...
	<?php echo bcn_display($return = false, $linked = true, $reverse = false, $force = false); ?>
		...
		<a name="Patient Questionnaire"></a>
		<?php 
...
?>
    ...
    <div class="container"><h3><?php echo $history_portal_title; ?></h3></div>
    <div class="patient_sec1">
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-6">
...
?> 
	   ...
	   <h2><?php the_title(); ?></h2><a name="Portal Solutions"></a>
        <?php echo $description; ?>
    </div>
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $referring_physician_portal_image1; ?>" alt="" ></div>
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-sm-5 col-sm-pull-5 center_767"><img src="<?php echo $image1; ?>" alt="" ></div>
            </div>
        </div>
    </div>
    <div class="container">
...
?> 		
    ...
    <div class="container"><a name="Recall Solutions"></a>
    	<h2><?php the_title(); ?></h2>
		<?php echo $description; ?>
        </div>
	<?php endwhile; ?>	
<?php wp_reset_query(); ?>	
    <div class="patient_bottom">
    	<div class="container">
            ...
            <a href="http://dev4work.com/magview/wp/solutions/lungview/radiologist-empowerment/" class="btn2">CONTINUE to Radiologist Empowerment</a>
        </div>
    </div>   
