...
<?php wp_reset_query(); ?>	
    ...
    <div class="container"><a name="Follow-up Tracking"></a>
<?php 
query_posts('page_id=205'); 
while (have_posts ()): the_post(); 
$description = get_post_meta( get_the_ID(), 'description', true);
?>
    	<h2><?php the_title(); ?></h2>
    ...
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $risk_portal_image1; ?>" alt=""></div>
            </div>
        </div>
    </div>
	<?php endwhile; ?>	
...
?>		
    ...
    <div class="patient_sec3" style="background-color:#ececec;margin-bottom:30px;">
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-5">
                	<h3><?php echo $worklist_tool_title; ?></h3>
                    <?php echo $worklist_tool_description; ?>
                </div>
                <div class="col-sm-5 col-sm-push-2 center_767"><img src="<?php echo $worklist_tool_image1; ?>" alt=""></div>
            </div>
        </div>
    </div>
...
<?php wp_reset_query(); ?>		
	...
	<div class="patient_bottom">
    	<div class="container">
            ...
            <a href="http://dev4work.com/magview/wp/solutions/breast-cancer/data-insight/" class="btn2">CONTINUE to DATA INSIGHT</a>
        </div>
    </div>
