...
$clarity_report_scheduling_title = get_post_meta( get_the_ID(), 'clarity_report_scheduling_title', true);
$clarity_report_scheduling_description = get_post_meta( get_the_ID(), 'clarity_report_scheduling_description', true);
$clarity_report_scheduling_image = get_post_meta( get_the_ID(), 'clarity_report_scheduling_image', true);
$clarity_report_scheduling_image1 = wp_get_attachment_url( $clarity_report_scheduling_image );
?>    
	...
	<div class="container-fluid">
    	<div class="row box3">	
        <div class="img_holder4 col-sm-6 same"><img src="<?php echo $clarity_report_scheduling_image1; ?>" alt="" class="full_width"></div>
        <div class="col-sm-5 same">
            <h3><?php echo $clarity_report_scheduling_title; ?></h3>
            <?php echo $clarity_report_scheduling_description; ?>
        </div>
    </div>	
</div>
<?php endwhile; ?>	
...
while (have_posts ()): the_post(); 
$description = get_post_meta( get_the_ID(), 'description', true);
$report_generation_image = get_post_meta( get_the_ID(), 'report_generation_image', true);
$report_generation_image1 = wp_get_attachment_url( $report_generation_image );
?>
<div class="container-fluid"><a name="<?php the_title(); ?>"></a>
    	<div class="row box3">	
        <div class="img_holder4 col-sm-6 col-sm-push-6 same"><img src="<?php echo $report_generation_image1; ?>" alt="" class="full_width"></div>
...
while (have_posts ()): the_post(); 
$description = get_post_meta( get_the_ID(), 'description', true);
$reports_image = get_post_meta( get_the_ID(), 'reports_image', true);
$reports_image1 = wp_get_attachment_url( $reports_image );
?> 
<div class="container-fluid"><a name="<?php the_title(); ?>"></a>
<div class="row box3">	
<div class="img_holder4 col-sm-6 same"><img src="<?php echo $reports_image1; ?>" alt="" class="full_width"></div>
<div class="col-sm-5 same">
	<h3><?php the_title(); ?></h3>
	<?php echo $description; ?>
</div>
...
$features_image = get_post_meta( get_the_ID(), 'features_image', true);
$features = get_post_meta( get_the_ID(), 'features', true);
$features_image1 = wp_get_attachment_url( $features_image );
?> 
	...
	<div class="container-fluid">
	<div class="row box3">	
		<div class="img_holder4 col-sm-6 col-sm-push-6 same"><img src="<?php echo $features_image1; ?>" alt="" class="full_width"></div>
		<div class="col-sm-5 col-sm-pull-5 same">
			<?php echo $features; ?>
		</div>
		</div>
		<div class="row box3">	
		<div class="img_holder4 col-sm-6 same"><img src="<?php echo $airport_image; ?>" alt="" class="full_width"></div>
		<div class="col-sm-5 same">
			<?php echo $benefits; ?>
		</div>
		</div>
...
<?php wp_reset_query(); ?>		
    ...
    <div class="patient_bottom">
    	<div class="container">
            ...
            <a href="http://www.magview.com/solutions/breast-cancer/compliance/" class="btn2">CONTINUE TO COMPLIANCE</a>
        </div>
    </div>
