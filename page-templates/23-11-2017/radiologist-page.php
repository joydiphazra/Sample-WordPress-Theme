...
?>	
    ...
    <div class="row box3">	
        <div class="img_holder4 col-sm-6 col-sm-push-6 same"><img src="<?php echo $airport_monitor_image1; ?>" alt="" class="full_width"></div>
        <div class="col-sm-5 col-sm-pull-5 same">
             <h3><?php echo $airport_monitor_title; ?></h3>
             <?php echo $airport_monitor_description; ?>
        </div>
    </div>
    </div>
<?php endwhile; ?>	
