<?php
/**
 * Template Name: Lungview Patient Experience Page Template
*/
...
<div class="container">
    ...
    <?php the_content(); ?>
			...
			<?php 
query_posts('page_id=591'); 
while (have_posts ()): the_post(); 
$patient_questionnaire_details = get_post_meta( get_the_ID(), 'patient_questionnaire_details', true);
$history_portal_title = get_post_meta( get_the_ID(), 'history_portal_title', true);
$history_portal_description = get_post_meta( get_the_ID(), 'history_portal_description', true);
...
<div class="container">
     ...
     <?php echo $patient_questionnaire_details; ?>
</div>
	 
	<div class="new_sec" style="background-color:#f9eafb;">
    	<div class="container">
        	<h2><?php echo $history_portal_title; ?></h2>
            <div class="col-sm-10 center-block">
            <?php echo $history_portal_description; ?>
            </div>
        </div>
    </div>
...
?>
    ...
    <div class="container-fluid">
        <div class="row box3">	
            <div class="img_holder4 col-sm-push-6 col-sm-6 same"><img src="<?php echo $notificationbig_image; ?>" alt="" class="full_width"></div>
            <div class="col-sm-5 col-sm-pull-5 same">                
                <?php echo $description; ?>                
            </div>
        </div>
...
$scheduling_title = get_post_meta( get_the_ID(), 'scheduling_title', true);
$scheduling_description = get_post_meta( get_the_ID(), 'scheduling_description', true);
$scheduling_image = get_post_meta( get_the_ID(), 'scheduling_image', true);
$first_image = wp_get_attachment_url( $texting_module_image );
$second_image = wp_get_attachment_url( $follow_up_image );
$scheduling_image1 = wp_get_attachment_url( $scheduling_image );
?>
...
<div class="container-fluid">
        ...
        <div class="row box3">	
<a name="<?php echo $scheduling_title; ?>"></a>
            <div class="img_holder4 col-sm-6 same"><img src="<?php echo $scheduling_image1; ?>" alt="" class="full_width"></div>
            <div class="col-sm-5 same">
                <h3><?php echo $scheduling_title; ?></h3>
                <?php echo $scheduling_description; ?>
            </div>
        </div>
    </div>
...
<?php wp_reset_query(); ?>	
    ...
    <div class="patient_bottom">
    	<div class="container">
            ...
            <a href="http://www.magview.com/solutions/lungview/radiologist-empowerment/" class="btn2">CONTINUE to Radiologist Empowerment</a>
        </div>
    </div>   
