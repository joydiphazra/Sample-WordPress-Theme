...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/jquery.meanmenu2.js"></script>
<script type="text/javascript" >
...
<?php if($pid==564 || $pid==572 || $pid==577 || $pid==580 || $pid==583 || $pid==586 ){?>
 <a href="#" class="btn1 gray" data-toggle="modal" data-target="#myModal1" >Request Demo</a>
<?php } else{ ?>
...
<?php } ?>
            ...
            <div class="col-lg-8 col-md-9 " id="navigation">
			
			<nav>
                	<div id="smoothmenu1" class="ddsmoothmenu">
					<?php wp_nav_menu( array('theme_location'  => 'primary', 'container' => '', 'container_id' => '', 'menu_class' => '') ); ?>
                    	<!--<ul>
						
                            <li class="active"><a href="#">Home</a></li>
                            <li><a href="solution.html">Solutions</a>
                            <ul>
                                    <li><a href="Breast_center.html">Breast Center</a></li>
                                    <li><a href="lung_screening.html">Lung Screening</a></li>
                                    <li><a href="patient_navigation.html">Patient Navigation</a></li>
                                    <li><a href="radiology_reporting.html">Radiology Reporting</a></li>
                                </ul>
                            </li>
                            <li><a href="about.html">About Us</a>
                                <ul>
                                    <li><a href="magview_difference.html">Magview Difference</a></li>
                                </ul>
                            </li>
